...
class SalesOrderTowScreen extends StatefulWidget {
  const SalesOrderTowScreen({super.key});

  @override
  State<SalesOrderTowScreen> createState() => _SalesOrderTowScreenState();
}

class _SalesOrderTowScreenState extends State<SalesOrderTowScreen> {
  DateTime? _fromDate;
  DateTime? _toDate;
                    ...
                    children: [
                      ...
                      Positioned(
                        ...
                        child: Row(
                          ...
                          children: [
                            SizedBox(
                              height: 30, // Increased for better usability
                              width: 30,
                              child: IconButton(
                                onPressed: () {},
                                icon: Icon(
                      ...
                      Positioned(
                        ...
                        child: Row(
                          ...
                          children: [
                            SizedBox(
                              width:
                                  120, // Adjusted width to avoid layout issues
