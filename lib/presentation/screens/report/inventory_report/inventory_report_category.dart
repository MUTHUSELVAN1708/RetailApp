...
class InventoryReportCategoryScreen extends StatefulWidget {
  const InventoryReportCategoryScreen({super.key});

  @override
  State<InventoryReportCategoryScreen> createState() =>
      _InventoryReportCategoryScreenState();
}

class _InventoryReportCategoryScreenState
    extends State<InventoryReportCategoryScreen> {
  String? selectedRole;
