...
class InventoryReportItemWiseScreen extends StatefulWidget {
  const InventoryReportItemWiseScreen({super.key});

  @override
  State<InventoryReportItemWiseScreen> createState() =>
      _InventoryReportItemWiseScreenState();
}

class _InventoryReportItemWiseScreenState
    extends State<InventoryReportItemWiseScreen> {
  String? selectedRole;
                ...
                child: SingleChildScrollView(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      _buildRow1('Qty', 'brand'),
                      _buildRow1('Discount', '0.00'),
                      _buildRow1('Tax', '380.60'),
                      _buildRow1('taxable value', '380.60'),
