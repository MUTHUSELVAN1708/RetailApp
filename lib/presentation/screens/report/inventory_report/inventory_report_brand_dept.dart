...
class InventoryReportBrandDeptScreen extends StatefulWidget {
  const InventoryReportBrandDeptScreen({super.key});

  @override
  State<InventoryReportBrandDeptScreen> createState() =>
      _InventoryReportBrandDeptScreenState();
}

class _InventoryReportBrandDeptScreenState
    extends State<InventoryReportBrandDeptScreen> {
  String? selectedRole;
