...
class InventoryReportBalanceScreen extends StatefulWidget {
  const InventoryReportBalanceScreen({super.key});

  @override
  State<InventoryReportBalanceScreen> createState() =>
      _InventoryReportBalanceScreenState();
}

class _InventoryReportBalanceScreenState
    extends State<InventoryReportBalanceScreen> {
  String? selectedRole;
                ...
                child: SingleChildScrollView(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      _buildRow1('QTY', '0.2400'),
                      _buildRow1('Value', '29.46'),
