...
class InventoryReportHsnScreen extends StatefulWidget {
  const InventoryReportHsnScreen({super.key});

  @override
  State<InventoryReportHsnScreen> createState() =>
      _InventoryReportHsnScreenState();
}

class _InventoryReportHsnScreenState extends State<InventoryReportHsnScreen> {
  String? selectedRole;
  ...
  final List<Map<String, dynamic>> items = [
    {
      ...
      'Item Name': 'jhon',
      'Qty': '400.00',
      'Taxable value': '0.2400',
      'CGST Amount': '29.46',
      'SGST/UTGST amount': '0.00',
      'IGST amount': '0.2400',
      'cess amount': '29.46',
      'Additional cess amount': '0.00',
      'amount': '29.46',
    },
    {
      'SNo': '1',
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                _buildRow(
                                  ...
                                  items[index]['Additional cess amount'] ?? '',
                                ),
                                _buildRow(
                                  'amount',
                                  items[index]['amount'] ?? '',
                ...
                child: SingleChildScrollView(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      _buildRow1('Qty', '400.00'),
                      _buildRow1('Taxable value', '0.2400'),
                      _buildRow1('CGST Amount', '29.46'),
                      _buildRow1('SGST/UTGST amount', '0.00'),
                      _buildRow1('IGST amount', '0.2400'),
                      _buildRow1('cess amount', '29.46'),
                      _buildRow1('Additional cess amount', '0.00'),
                      _buildRow1('amount', '29.46'),
