...
class InventoryReportFastSellingScreen extends StatefulWidget {
  const InventoryReportFastSellingScreen({super.key});

  @override
  State<InventoryReportFastSellingScreen> createState() =>
      _InventoryReportFastSellingScreenState();
}

class _InventoryReportFastSellingScreenState
    extends State<InventoryReportFastSellingScreen> {
  String? selectedRole;
