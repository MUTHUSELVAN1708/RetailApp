...
class InventoryReportMinimumScreen extends StatefulWidget {
  const InventoryReportMinimumScreen({super.key});

  @override
  State<InventoryReportMinimumScreen> createState() =>
      _InventoryReportMinimumScreenState();
}

class _InventoryReportMinimumScreenState
    extends State<InventoryReportMinimumScreen> {
  String? selectedRole;
