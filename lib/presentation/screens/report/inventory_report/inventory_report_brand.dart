...
class InventoryReportBrandScreen extends StatefulWidget {
  const InventoryReportBrandScreen({super.key});

  @override
  State<InventoryReportBrandScreen> createState() =>
      _InventoryReportBrandScreenState();
}

class _InventoryReportBrandScreenState
    extends State<InventoryReportBrandScreen> {
  String? selectedRole;
