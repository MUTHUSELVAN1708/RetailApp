...
class InventoryReportItemBrandScreen extends StatefulWidget {
  const InventoryReportItemBrandScreen({super.key});

  @override
  State<InventoryReportItemBrandScreen> createState() =>
      _InventoryReportItemBrandScreenState();
}

class _InventoryReportItemBrandScreenState
    extends State<InventoryReportItemBrandScreen> {
  String? selectedRole;
                          ...
                          child: Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                _buildRow(
                                  'Sales Qty',
                                  items[index]['Sales Qty'] ?? '',
                                ),
                                _buildRow(
                                  'Sales Value',
                                  items[index]['Sales Value'] ?? '',
                                ),
                                _buildRow(
                                  'Return Qty',
                                  items[index]['Return Qty'] ?? '',
                                ),
                                _buildRow(
                                  'Return Value',
                ...
                child: SingleChildScrollView(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      _buildRow1('Sales Qty', '3.24'),
                      _buildRow1('Sales Value', '29.46'),
                      _buildRow1('Return Qty', '1.00'),
                      _buildRow1(
                        'Return Value',
                        '1.00',
                      ),
                      _buildRow1('Net Qty', '0'),
                      _buildRow1('Net Value', '0'),
