...
class OtherReportUserDetailScreen extends StatefulWidget {
  const OtherReportUserDetailScreen({super.key});

  @override
  State<OtherReportUserDetailScreen> createState() =>
      _OtherReportUserDetailScreenState();
}

class _OtherReportUserDetailScreenState
    extends State<OtherReportUserDetailScreen> {
  String? selectedRole;
                ...
                child: SingleChildScrollView(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      _buildRow1('Bill Count', '4'),
                      _buildRow1('Total Item', '4'),
                      _buildRow1('Discount', '29.47'),
                      _buildRow1('Tax', '70.00'),
                      _buildRow1('Bill Amount', '400.0'),
