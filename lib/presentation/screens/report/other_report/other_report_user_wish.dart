...
class OtherReportUserWishScreen extends StatefulWidget {
  const OtherReportUserWishScreen({super.key});

  @override
  State<OtherReportUserWishScreen> createState() =>
      _OtherReportUserWishScreenState();
}

class _OtherReportUserWishScreenState extends State<OtherReportUserWishScreen> {
  String? selectedRole;
