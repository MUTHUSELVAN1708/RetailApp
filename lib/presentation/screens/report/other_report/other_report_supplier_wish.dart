...
class OtherReportSupplierWishScreen extends StatefulWidget {
  const OtherReportSupplierWishScreen({super.key});

  @override
  State<OtherReportSupplierWishScreen> createState() =>
      _OtherReportSupplierWishScreenState();
}

class _OtherReportSupplierWishScreenState
    extends State<OtherReportSupplierWishScreen> {
  String? selectedRole;
