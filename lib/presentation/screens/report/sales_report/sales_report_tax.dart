...
class SalesReportTaxScreen extends StatefulWidget {
  const SalesReportTaxScreen({super.key});

  @override
  State<SalesReportTaxScreen> createState() => _SalesReportTaxScreenState();
}

class _SalesReportTaxScreenState extends State<SalesReportTaxScreen> {
  String? selectedRole;
  DateTime? _fromDate;
  DateTime? _toDate;
                          ...
                          child: Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                _buildRow(
                                  'Tax Amount',
                                  items[index]['Tax Amount'] ?? '',
                                ),
                                _buildRow(
                                  'Taxable Amount',
                                  items[index]['Taxable Amount'] ?? '',
                                ),
                              ],
                            ),
                          ),
