...
class SalesReportBitwiseScreen extends StatefulWidget {
  const SalesReportBitwiseScreen({super.key});

  @override
  State<SalesReportBitwiseScreen> createState() =>
      _SalesReportBitwiseScreenState();
}

class _SalesReportBitwiseScreenState extends State<SalesReportBitwiseScreen> {
  String? selectedRole;
  DateTime? _fromDate;
  DateTime? _toDate;
                ...
                child: SingleChildScrollView(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      _buildRow1("Total Tax", "350.00"),
                      _buildRow1("Discount Amount", "0.00/-"),
