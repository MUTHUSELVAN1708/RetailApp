...
class SalesReportProfitScreen extends StatefulWidget {
  const SalesReportProfitScreen({super.key});

  @override
  State<SalesReportProfitScreen> createState() =>
      _SalesReportProfitScreenState();
}

class _SalesReportProfitScreenState extends State<SalesReportProfitScreen> {
  String? selectedRole;
  DateTime? _fromDate;
  DateTime? _toDate;
                          ...
                          child: Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                _buildRow(
                                  'Total Cost Price',
                                  items[index]['Total Cost Price'] ?? '',
                                ),
                                _buildRow(
                                  'Total Selling Price',
                                  items[index]['Total Selling Price'] ?? '',
                                ),
                                _buildRow(
                                  'Profit',
                                  items[index]['Profit'] ?? '',
                ...
                child: SingleChildScrollView(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      _buildRow1('Item Quantity', '3.240'),
                      _buildRow1('Total Cost Price', '0.00'),
                      _buildRow1('Total Selling Price', '123.12'),
                      _buildRow1('Profit', '123.12'),
                      _buildRow1('Discount', '3.08'),
