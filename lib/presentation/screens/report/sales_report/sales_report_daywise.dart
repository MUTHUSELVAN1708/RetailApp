...
class SalesReportDayWiseScreen extends StatefulWidget {
  const SalesReportDayWiseScreen({super.key});

  @override
  State<SalesReportDayWiseScreen> createState() =>
      _SalesReportDayWiseScreenState();
}

class _SalesReportDayWiseScreenState extends State<SalesReportDayWiseScreen> {
  String? selectedRole;
  DateTime? _fromDate;
  DateTime? _toDate;
                ...
                child: SingleChildScrollView(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      _buildRow1('Total Bills', '5'),
                      _buildRow1('Discount', ' 0.00'),
                      _buildRow1('IGST Amount', '0.00'),
                      _buildRow1('CGST amount', '3.08'),
                      _buildRow1('UTGST/SGST Amount', '3.08'),
                      _buildRow1('Cess Amount', '344.00'),
                      _buildRow1('Bill Amount', '607.00'),
                      _buildRow1('Return Value', '144.90'),
                      _buildRow1('Total', '462.00'),
