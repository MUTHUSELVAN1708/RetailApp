...
class SalesReportReturnScreen extends StatefulWidget {
  const SalesReportReturnScreen({super.key});

  @override
  State<SalesReportReturnScreen> createState() =>
      _SalesReportReturnScreenState();
}

class _SalesReportReturnScreenState extends State<SalesReportReturnScreen> {
  String? selectedRole;
  DateTime? _fromDate;
  DateTime? _toDate;
  ...
  final List<Map<String, dynamic>> items = [
    {
      'SNo': '1',
      'Invoice Date': 'Feb 02,2025',
      'CDNI': '1',
      'Return Date': 'Feb 12,2025',
      'Invoice NO': '4',
      'Item Name': 'corn',
      'UOM': '',
      'Billed Qty': '1.00',
      'Return Qty': '1.00',
      'Return Amount': '144.90',
    },
    {
      'SNo': '1',
      'Invoice Date': 'Feb 02,2025',
                          ...
                          child: Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                _buildRow(
                                  'Return Date',
                                  items[index]['Return Date'] ?? '',
                                ),
                                _buildRow(
                                  'Invoice NO',
                                  items[index]['Invoice NO'] ?? '',
                                ),
                                _buildRow(
                                  'Item Name',
