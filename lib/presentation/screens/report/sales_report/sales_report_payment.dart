...
class SalesReportPaymentScreen extends StatefulWidget {
  const SalesReportPaymentScreen({super.key});

  @override
  State<SalesReportPaymentScreen> createState() =>
      _SalesReportPaymentScreenState();
}

class _SalesReportPaymentScreenState extends State<SalesReportPaymentScreen> {
  String? selectedRole;
  DateTime? _fromDate;
  DateTime? _toDate;
                          ...
                          child: Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                _buildRow(
                                  'Payment/Receipt No',
                                  items[index]['Payment/Receipt No'] ?? '',
                                ),
                                _buildRow(
                                  'Description',
