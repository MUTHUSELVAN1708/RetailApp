...
class SalesReportRateSlabScreen extends StatefulWidget {
  const SalesReportRateSlabScreen({super.key});

  @override
  State<SalesReportRateSlabScreen> createState() =>
      _SalesReportRateSlabScreenState();
}

class _SalesReportRateSlabScreenState extends State<SalesReportRateSlabScreen> {
  String? selectedRole;
  DateTime? _fromDate;
  DateTime? _toDate;
