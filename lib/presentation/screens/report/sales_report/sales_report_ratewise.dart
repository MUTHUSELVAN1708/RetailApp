...
class SalesReportRateWiseScreen extends StatefulWidget {
  const SalesReportRateWiseScreen({super.key});

  @override
  State<SalesReportRateWiseScreen> createState() =>
      _SalesReportRateWiseScreenState();
}

class _SalesReportRateWiseScreenState extends State<SalesReportRateWiseScreen> {
  String? selectedRole;
  DateTime? _fromDate;
  DateTime? _toDate;
