            ...
            children: [
              ...
              CustomDropdown(
                ...
                onChanged: (String? newValue) {
                  ...
                  if (newValue != null) {
                    if (newValue == "Bill Wise Report") {
                      // Navigate to BillWiseScreen
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => SalesReportBitwiseScreen()),
                      );
                    } else {
                      // Navigate to Generic Report Screen
                      // Navigator.push(
                      //   context,
                      //   MaterialPageRoute(
                      //     builder: (context) => ReportDetailScreen(reportName: newValue),
                      //   ),
                      // );
                    }
                  }
