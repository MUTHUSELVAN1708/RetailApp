...
class SalesReportMonthWiseScreen extends StatefulWidget {
  const SalesReportMonthWiseScreen({super.key});

  @override
  State<SalesReportMonthWiseScreen> createState() =>
      _SalesReportMonthWiseScreenState();
}

class _SalesReportMonthWiseScreenState
    extends State<SalesReportMonthWiseScreen> {
  String? selectedRole;
  DateTime? _fromDate;
  DateTime? _toDate;
