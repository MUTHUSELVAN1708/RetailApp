...
class CloudReportSupplierScreen extends StatefulWidget {
  const CloudReportSupplierScreen({super.key});

  @override
  State<CloudReportSupplierScreen> createState() =>
      _CloudReportSupplierScreenState();
}

class _CloudReportSupplierScreenState extends State<CloudReportSupplierScreen> {
  String? selectedRole;
          ...
          child: Column(
            ...
            children: [
              ...
              Column(
                ...
                children: [
                  InfoCard(title: "Data Type", value: "Supplier Details"),
                  SizedBox(height: 12),
