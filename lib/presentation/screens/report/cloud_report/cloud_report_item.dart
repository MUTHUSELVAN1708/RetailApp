...
class CloudReportItemScreen extends StatefulWidget {
  const CloudReportItemScreen({super.key});

  @override
  State<CloudReportItemScreen> createState() => _CloudReportItemScreenState();
}

class _CloudReportItemScreenState extends State<CloudReportItemScreen> {
  String? selectedRole;
          ...
          child: Column(
            ...
            children: [
              ...
              Column(
                ...
                children: [
                  InfoCard(title: "Data Type", value: "items"),
                  SizedBox(height: 12),
