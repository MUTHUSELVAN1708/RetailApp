...
class CloudActivityReportScreen extends StatefulWidget {
  const CloudActivityReportScreen({super.key});

  @override
  State<CloudActivityReportScreen> createState() =>
      _CloudActivityReportScreenState();
}

class _CloudActivityReportScreenState extends State<CloudActivityReportScreen> {
  String? selectedRole;
