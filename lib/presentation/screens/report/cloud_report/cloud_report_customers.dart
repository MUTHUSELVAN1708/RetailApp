...
class CloudReportCustomersScreen extends StatefulWidget {
  const CloudReportCustomersScreen({super.key});

  @override
  State<CloudReportCustomersScreen> createState() =>
      _CloudReportCustomersScreenState();
}

class _CloudReportCustomersScreenState
    extends State<CloudReportCustomersScreen> {
  String? selectedRole;
          ...
          child: Column(
            ...
            children: [
              ...
              Column(
                ...
                children: [
                  InfoCard(title: "Data Type", value: "Customers"),
                  SizedBox(height: 12),
