...
class CloudReportPoGinScreen extends StatefulWidget {
  const CloudReportPoGinScreen({super.key});

  @override
  State<CloudReportPoGinScreen> createState() => _CloudReportPoGinScreenState();
}

class _CloudReportPoGinScreenState extends State<CloudReportPoGinScreen> {
  String? selectedRole;
          ...
          child: Column(
            ...
            children: [
              ...
              Column(
                ...
                children: [
                  InfoCard(title: "Data Type", value: "PO GIN Details"),
                  SizedBox(height: 12),
