...
class CloudReportInvoicesScreen extends StatefulWidget {
  const CloudReportInvoicesScreen({super.key});

  @override
  State<CloudReportInvoicesScreen> createState() =>
      _CloudReportInvoicesScreenState();
}

class _CloudReportInvoicesScreenState extends State<CloudReportInvoicesScreen> {
  String? selectedRole;
          ...
          child: Column(
            ...
            children: [
              ...
              Column(
                ...
                children: [
                  InfoCard(title: "Data Type", value: "Invoices"),
                  SizedBox(height: 12),
